...
create unique index patchSetsOnShopSeqAndKeyCardId on patchSets(createdByShopId,createdByKeyCardId);
...
create table patches (
    ...
    mmrProof bytea NOT NULL, -- CBOR array: [leaf_index, tree_size, [proof_1, ...]] see https://github.com/masslbs/go-pgmmr
