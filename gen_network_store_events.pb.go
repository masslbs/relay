// Generated from /nix/store/2xivjaknq61mlkakmrdd4zqksqa0p0ii-source/network-schema/store_events.proto at version v2 (64d582e035063484932d49537ca0bb135c1cd36c)
...
type UpdateOrder_ItemsFinalized struct {
	...
	PaymentId []byte `protobuf:"bytes,1,opt,name=payment_id,json=paymentId,proto3" json:"payment_id,omitempty"` // for verification. Compare against getPaymentId(PaymentReq)
...
var file_store_events_proto_rawDesc = []byte{
	...
	0x04, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x8d, 0x01, 0x0a, 0x0b, 0x43,
...
var file_store_events_proto_goTypes = []interface{}{
	...
	(*CreateOrder)(nil),                    // 11: market.mass.CreateOrder
	(*UpdateOrder)(nil),                    // 12: market.mass.UpdateOrder
	(*StoreEvent)(nil),                     // 13: market.mass.StoreEvent
	(*UpdateOrder_ChangeItems)(nil),        // 14: market.mass.UpdateOrder.ChangeItems
	(*UpdateOrder_ItemsFinalized)(nil),     // 15: market.mass.UpdateOrder.ItemsFinalized
	(*UpdateOrder_OrderCanceled)(nil),      // 16: market.mass.UpdateOrder.OrderCanceled
}
var file_store_events_proto_depIdxs = []int32{
	...
	14, // 3: market.mass.UpdateOrder.change_items:type_name -> market.mass.UpdateOrder.ChangeItems
	15, // 4: market.mass.UpdateOrder.items_finalized:type_name -> market.mass.UpdateOrder.ItemsFinalized
	16, // 5: market.mass.UpdateOrder.order_canceled:type_name -> market.mass.UpdateOrder.OrderCanceled
	3,  // 6: market.mass.StoreEvent.store_manifest:type_name -> market.mass.StoreManifest
	4,  // 7: market.mass.StoreEvent.update_store_manifest:type_name -> market.mass.UpdateStoreManifest
	5,  // 8: market.mass.StoreEvent.create_item:type_name -> market.mass.CreateItem
	6,  // 9: market.mass.StoreEvent.update_item:type_name -> market.mass.UpdateItem
	7,  // 10: market.mass.StoreEvent.create_tag:type_name -> market.mass.CreateTag
	8,  // 11: market.mass.StoreEvent.update_tag:type_name -> market.mass.UpdateTag
	11, // 12: market.mass.StoreEvent.create_order:type_name -> market.mass.CreateOrder
	12, // 13: market.mass.StoreEvent.update_order:type_name -> market.mass.UpdateOrder
	9,  // 14: market.mass.StoreEvent.change_stock:type_name -> market.mass.ChangeStock
	10, // 15: market.mass.StoreEvent.new_key_card:type_name -> market.mass.NewKeyCard
