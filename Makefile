...
reuse:
	reuse annotate --license  $(LIC) --copyright $(CPY) --merge-copyrights Makefile README.md *.go internal/contractabis/*.go go.mod *.nix .gitignore .github/workflows/test.yml *.bash db/schema.sql
