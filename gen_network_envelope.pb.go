// Generated from /nix/store/71rh2ghi6lii0mrz8mbw6b6fwal8v5yn-source/network-schema/envelope.proto at version v3 (9d18c2fd2a1a0367d1ab833ad0d759a4b65c0047)
...
func (x *Envelope) GetSubscriptionCancelRequest() *SubscriptionCancelRequest {
	if x, ok := x.GetMessage().(*Envelope_SubscriptionCancelRequest); ok {
